        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <SlideUp>
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium tracking-wide uppercase mb-6">
              <Cpu className="w-4 h-4" /> Enterprise Backends
            </div>

            <h1 className="text-4xl md:text-6xl font-light tracking-tight mb-6 leading-tight">
              Frameworks & <span className="text-red-500 font-normal">Architecture</span>
            </h1>

            <p className="text-gray-300 text-base md:text-xl font-light leading-relaxed max-w-3xl">
              Keptel builds scalable, high-performance enterprise applications using modern backend frameworks such as Spring Boot, Kafka, and microservices. These frameworks power mission-critical workloads and distributed systems.
            </p>
          </SlideUp>
        </div>
      </div>
        ...
        <SlideUp>
          <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-slate-200/80 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-2xl font-light text-slate-900 tracking-tight">Technologies & Frameworks</h2>
            </div>

            <div className="flex flex-wrap gap-2.5">
              {[
                "Spring Boot", "Kafka", "Java", ".NET", "Python", 
                "Event Streaming", "API Gateways", "Kubernetes-based Runtime Environments"
              ].map((tech, index) => (
                <span 
                  key={index} 
